...
/**
 * Alert formatter for stick threads alerts.
 */
class MybbStuff_MyAlerts_Formatter_StickThreadsFormatter extends MybbStuff_MyAlerts_Formatter_AbstractFormatter
{
    /**
