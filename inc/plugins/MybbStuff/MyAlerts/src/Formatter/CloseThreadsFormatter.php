...
/**
 * Alert formatter for close threads alerts.
 */
class MybbStuff_MyAlerts_Formatter_CloseThreadsFormatter extends MybbStuff_MyAlerts_Formatter_AbstractFormatter
{
    /**
