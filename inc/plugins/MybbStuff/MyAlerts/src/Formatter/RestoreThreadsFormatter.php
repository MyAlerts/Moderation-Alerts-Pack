...
/**
 * Alert formatter for restore threads alerts.
 */
class MybbStuff_MyAlerts_Formatter_RestoreThreadsFormatter extends MybbStuff_MyAlerts_Formatter_AbstractFormatter
{
    /**
